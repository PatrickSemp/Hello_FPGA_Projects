...
entity MEM_FI_MEM_FI_0_TPSRAM is
...
end MEM_FI_MEM_FI_0_TPSRAM;

architecture DEF_ARCH of MEM_FI_MEM_FI_0_TPSRAM is 
...
begin 
    ...
    MEM_FI_MEM_FI_0_TPSRAM_R0C2 : RAM1K18
      port map(A_DOUT(17) => nc123, A_DOUT(16) => nc121, 
        ...
        A_ARST_N => \VCC\, A_DOUT_EN => \VCC\, A_BLK(2) => \VCC\, 
        ...
        \GND\, A_ADDR(10) => \GND\, A_ADDR(9) => \GND\, A_ADDR(8)
         => \GND\, A_ADDR(7) => \GND\, A_ADDR(6) => \GND\, 
        A_ADDR(5) => \GND\, A_ADDR(4) => \GND\, A_ADDR(3) => 
        ...
        \GND\, B_ADDR(10) => \GND\, B_ADDR(9) => \GND\, B_ADDR(8)
         => \GND\, B_ADDR(7) => \GND\, B_ADDR(6) => \GND\, 
        B_ADDR(5) => \GND\, B_ADDR(4) => WADDR(0), B_ADDR(3) => 
    ...
    MEM_FI_MEM_FI_0_TPSRAM_R0C1 : RAM1K18
      port map(A_DOUT(17) => nc127, A_DOUT(16) => nc99, 
        ...
        A_ADDR(11) => \GND\, A_ADDR(10) => \GND\, A_ADDR(9) => 
        \GND\, A_ADDR(8) => \GND\, A_ADDR(7) => \GND\, A_ADDR(6)
         => \GND\, A_ADDR(5) => \GND\, A_ADDR(4) => \GND\, 
        A_ADDR(3) => RADDR(2), A_ADDR(2) => RADDR(1), A_ADDR(1)
         => RADDR(0), A_ADDR(0) => \GND\, A_WEN(1) => \GND\, 
        A_WEN(0) => \GND\, B_CLK => WCLK, B_DOUT_CLK => \VCC\, 
        B_ARST_N => \VCC\, B_DOUT_EN => \VCC\, B_BLK(2) => WEN, 
        B_BLK(1) => \VCC\, B_BLK(0) => \VCC\, B_DOUT_ARST_N => 
        \GND\, B_DOUT_SRST_N => \VCC\, B_DIN(17) => \GND\, 
        B_DIN(16) => WD(59), B_DIN(15) => WD(58), B_DIN(14) => 
        WD(51), B_DIN(13) => WD(50), B_DIN(12) => WD(43), 
        B_DIN(11) => WD(42), B_DIN(10) => WD(35), B_DIN(9) => 
        WD(34), B_DIN(8) => \GND\, B_DIN(7) => WD(27), B_DIN(6)
         => WD(26), B_DIN(5) => WD(19), B_DIN(4) => WD(18), 
        B_DIN(3) => WD(11), B_DIN(2) => WD(10), B_DIN(1) => WD(3), 
        B_DIN(0) => WD(2), B_ADDR(13) => \GND\, B_ADDR(12) => 
        \GND\, B_ADDR(11) => \GND\, B_ADDR(10) => \GND\, 
        B_ADDR(9) => \GND\, B_ADDR(8) => \GND\, B_ADDR(7) => 
        \GND\, B_ADDR(6) => \GND\, B_ADDR(5) => \GND\, B_ADDR(4)
    ...
    MEM_FI_MEM_FI_0_TPSRAM_R0C3 : RAM1K18
      port map(A_DOUT(17) => nc87, A_DOUT(16) => nc133, 
        ...
        B_DOUT_EN => \VCC\, B_BLK(2) => WEN, B_BLK(1) => \VCC\, 
        B_BLK(0) => \VCC\, B_DOUT_ARST_N => \GND\, B_DOUT_SRST_N
         => \VCC\, B_DIN(17) => \GND\, B_DIN(16) => WD(63), 
        B_DIN(15) => WD(62), B_DIN(14) => WD(55), B_DIN(13) => 
        WD(54), B_DIN(12) => WD(47), B_DIN(11) => WD(46), 
        B_DIN(10) => WD(39), B_DIN(9) => WD(38), B_DIN(8) => 
        \GND\, B_DIN(7) => WD(31), B_DIN(6) => WD(30), B_DIN(5)
         => WD(23), B_DIN(4) => WD(22), B_DIN(3) => WD(15), 
        B_DIN(2) => WD(14), B_DIN(1) => WD(7), B_DIN(0) => WD(6), 
        B_ADDR(13) => \GND\, B_ADDR(12) => \GND\, B_ADDR(11) => 
        \GND\, B_ADDR(10) => \GND\, B_ADDR(9) => \GND\, B_ADDR(8)
         => \GND\, B_ADDR(7) => \GND\, B_ADDR(6) => \GND\, 
        B_ADDR(5) => \GND\, B_ADDR(4) => WADDR(0), B_ADDR(3) => 
    ...
    MEM_FI_MEM_FI_0_TPSRAM_R0C0 : RAM1K18
      port map(A_DOUT(17) => nc97, A_DOUT(16) => nc85, A_DOUT(15)
        ...
        A_DOUT(1) => RD(1), A_DOUT(0) => RD(0), B_DOUT(17) => nc8, 
        ...
        B_DOUT_EN => \VCC\, B_BLK(2) => WEN, B_BLK(1) => \VCC\, 
        B_BLK(0) => \VCC\, B_DOUT_ARST_N => \GND\, B_DOUT_SRST_N
         => \VCC\, B_DIN(17) => \GND\, B_DIN(16) => WD(57), 
        B_DIN(15) => WD(56), B_DIN(14) => WD(49), B_DIN(13) => 
        WD(48), B_DIN(12) => WD(41), B_DIN(11) => WD(40), 
        B_DIN(10) => WD(33), B_DIN(9) => WD(32), B_DIN(8) => 
        \GND\, B_DIN(7) => WD(25), B_DIN(6) => WD(24), B_DIN(5)
         => WD(17), B_DIN(4) => WD(16), B_DIN(3) => WD(9), 
        B_DIN(2) => WD(8), B_DIN(1) => WD(1), B_DIN(0) => WD(0), 
        B_ADDR(13) => \GND\, B_ADDR(12) => \GND\, B_ADDR(11) => 
        \GND\, B_ADDR(10) => \GND\, B_ADDR(9) => \GND\, B_ADDR(8)
         => \GND\, B_ADDR(7) => \GND\, B_ADDR(6) => \GND\, 
        B_ADDR(5) => \GND\, B_ADDR(4) => WADDR(0), B_ADDR(3) => 
