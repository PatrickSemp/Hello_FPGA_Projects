...
entity TPSRAM_C3_TPSRAM_C3_0_TPSRAM is
...
end TPSRAM_C3_TPSRAM_C3_0_TPSRAM;

architecture DEF_ARCH of TPSRAM_C3_TPSRAM_C3_0_TPSRAM is 
...
begin 
    ...
    TPSRAM_C3_TPSRAM_C3_0_TPSRAM_R0C2 : RAM1K18
      port map(A_DOUT(17) => nc123, A_DOUT(16) => nc121, 
        ...
        B_DOUT_ARST_N => \GND\, B_DOUT_SRST_N => \VCC\, B_DIN(17)
         => \GND\, B_DIN(16) => WD(61), B_DIN(15) => WD(60), 
        B_DIN(14) => WD(53), B_DIN(13) => WD(52), B_DIN(12) => 
        WD(45), B_DIN(11) => WD(44), B_DIN(10) => WD(37), 
        B_DIN(9) => WD(36), B_DIN(8) => \GND\, B_DIN(7) => WD(29), 
        B_DIN(6) => WD(28), B_DIN(5) => WD(21), B_DIN(4) => 
        WD(20), B_DIN(3) => WD(13), B_DIN(2) => WD(12), B_DIN(1)
         => WD(5), B_DIN(0) => WD(4), B_ADDR(13) => \GND\, 
    ...
    TPSRAM_C3_TPSRAM_C3_0_TPSRAM_R0C3 : RAM1K18
    ...
    TPSRAM_C3_TPSRAM_C3_0_TPSRAM_R0C1 : RAM1K18
      port map(A_DOUT(17) => nc87, A_DOUT(16) => nc133, 
        ...
        A_DOUT(1) => RD(3), A_DOUT(0) => RD(2), B_DOUT(17) => nc1, 
    ...
    TPSRAM_C3_TPSRAM_C3_0_TPSRAM_R0C0 : RAM1K18
